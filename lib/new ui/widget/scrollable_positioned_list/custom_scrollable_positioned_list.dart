...
import 'package:finutss/new%20ui/widget/scrollable_positioned_list/item_position_notifier.dart';
...
class CustomScrollablePositionedList extends StatefulWidget {
  ...
  /// [itemBuilder].
  CustomScrollablePositionedList.builder({
  ...
  CustomScrollablePositionedList.separated(
      {required this.itemCount,
      required this.itemBuilder,
...
class _ScrollablePositionedListState
    extends State<CustomScrollablePositionedList>
  ...
  @override
  void didUpdateWidget(CustomScrollablePositionedList oldWidget) {
    ...
    if (itemPosition != null) {
      ...
      await widget.scrollController?.animateTo(
          widget.scrollController!.offset +
              localScrollAmount -
              alignment * widget.scrollController!.position.viewportDimension,
          duration: duration,
          curve: curve);
    } else {
      ...
      startAnimationCallback = () {
        SchedulerBinding.instance.addPostFrameCallback((_) {
          ...
          startCompleter.complete(widget.scrollController!.animateTo(
              widget.scrollController!.offset + direction * scrollAmount,
              duration: duration,
              curve: curve));

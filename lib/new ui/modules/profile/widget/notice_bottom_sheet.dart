...
Future<void> NoticeBottomSheet(BuildContext context) {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "After changing the nickname, it can not be changed for 30 days. Would you like to change your nickname now?",

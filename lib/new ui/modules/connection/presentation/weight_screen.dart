...
class WeightSelectionScreen extends StatelessWidget {
  WeightSelectionScreen({Key? key}) : super(key: key);
                  ...
                  return Container(
                    child: CupertinoPicker(
                      scrollController: FixedExtentScrollController(
                          initialItem: controller.selectIndexWeight.value),
                      onSelectedItemChanged: (index) {
                        controller.selectIndexWeight.value = index;
                        controller.selectWeight = (controller
                                .weightList[controller.selectIndexWeight.value])
                            .toString();
                      },
                      itemExtent: 60.h,
                      looping: false,
                      ...
                      children: [
                        for (var index = 0;
                          ...
                          CustomVIew.customSelectWheelItem(
                            text: controller.selectIndexWeight == index
                                ? (controller.weightList[index]).toString() +
                                    " " + "KG".tr
                                : (controller.weightList[index]).toString(),
                            height: 45.h,
                            isSelect: controller.selectIndexWeight == index
                                ? true
                                : false,

                  ...
                  if (description != null || status != null)
                    Row(
                      ...
                      children: [
                        ...
                        customText(
                            text: status ?? '', fontSize: 14, fontWeight: FontWeight.w400, fontColor: statusColor),
                      ],
                    )
                ],
              ),
            ),
            if (activeValue != null) customText(text: '$activeValue', fontColor: Color(0xff7F8391), fontSize: 12),
            size5,
            if (isSuffixIconShow)
              Icon(
                icon,

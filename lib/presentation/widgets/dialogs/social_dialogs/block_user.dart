...
import 'package:finutss/presentation/widgets/dialogs/social_dialogs/confirm_block_dialog.dart';
            ...
            children: [
              Positioned(
                ...
                child: Column(
                  children: [
                    Center(
                      child: headingWidget(title: 'BLOCK'.tr),
                    ),
                    Expanded(
                      child: Column(
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: customButton(
                              onTapFunction: () async {
                                var result = await GlobalBloc().queryMutate(BlockQueries.ADD_BLOCK, {
                                  'data': {
                                ...
                                if (!result['success']) {
                                  ...
                                  Get.back();
                                  Get.dialog(ConfirmBlockDialog());
                                  blockListController.callApiBlocks();
                                }
                              },
                              radius: 16,
                              height: 48,

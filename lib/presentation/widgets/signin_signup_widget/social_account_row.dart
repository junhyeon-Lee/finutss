    ...
    child: Row(
      ...
      children: [
        _socialAccountsAvatar(
            imagePath:
                'assets/images/social_accounts/kakao_logo_circle_128.png',
            type: 'kakao',
            url: 'https://api.finutss.com/auth/social/kakao'),
        _socialAccountsAvatar(
            imagePath:
                'assets/images/social_accounts/google_logo_circle_128.png',
            type: 'google',
...
_socialAccountsAvatar(
    {required String imagePath, required String type, required String url}) {
  return IconButton(
    icon: CircleAvatar(

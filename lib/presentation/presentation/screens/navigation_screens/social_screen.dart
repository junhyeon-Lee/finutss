            ...
            return Container(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 16.w, right: 16.w, top: 8.0.h, bottom: 13.h),
                      child: HotPeople(),
                    ),
                    size15,
                    /* ---------------------------- users in workout ---------------------------- */
                    ...
                    Padding(
                      ...
                      child: UsersInWorkout(userID: authController.user?.userId),
                    ),
        ...
        GetBuilder<RecommandController>(builder: (recommandController) {
          return Container(
            ...
            child: ListView.builder(
              ...
              itemCount: recommandController.docs.length > 5 ? 5 : recommandController.docs.length,
              itemBuilder: (context, index) {
                return Padding(
                  padding: index != 0 ? EdgeInsets.all(8.r) : EdgeInsets.fromLTRB(0, 8.h, 8.w, 8.h),
        ...
        GetBuilder<HotPeopleController>(builder: (hotPeopleController) {
          return Container(
            ...
            child: GridView.builder(
              itemCount: hotPeopleController.docs.length > 6 ? 6 : hotPeopleController.docs.length, //item 개수
      ...
      children: [
        ...
        GetBuilder<WorkoutInController>(builder: (workoutInController) {
          return Container(
            height: 250,
            child: GridView.builder(
              itemCount: workoutInController.docs.length > 6 ? 6 : workoutInController.docs.length, //item 개수
              physics: new NeverScrollableScrollPhysics(),
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 3, //1 개의 행에 보여줄 item 개수
                childAspectRatio: 1 / 1, //item 의 가로 1, 세로 2 의 비율

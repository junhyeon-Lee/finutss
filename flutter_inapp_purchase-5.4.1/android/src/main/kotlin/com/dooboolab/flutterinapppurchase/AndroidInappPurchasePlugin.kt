    ...
    private fun buyProduct(
        ...
        try {
            ...
            val productDetailsParamsList = listOf(
                    if (offerToken == null) ProductDetailsParams.newBuilder()
                    .setProductDetails(selectedProductDetails).build()
            else ProductDetailsParams.newBuilder()
                            .setProductDetails(selectedProductDetails).setOfferToken(offerToken).build()
            )
